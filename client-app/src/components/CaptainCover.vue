<template>
  <div class="captain-cover-root">
    <img
      v-if="coverBottomBgUrl"
      class="captain-cover-backdrop"
    ...
    <PgScreenCompat backdrop-transparent>
      <div id="splash" class="screen_compat screen_color">
        <img v-if="coverBgUrl" class="cover-bg" :src="coverBgUrl" alt="" />
          ...
          <div v-if="phase === 'loading'" class="loading-container-port">
            <div class="progress-bar-container-port">
              ...
              <div class="progress-bar-fill-container">
                <div class="progress-bar-fill stripes" :style="{ width: `${progress}%` }">
...
function startLoading() {
  ...
  progressTimer = window.setInterval(() => {
    const ratio = Math.min(1, (Date.now() - startAt) / durationMs)
...
.border-inner { border: 1.7px solid #272727; }
.border-outer { border: 0.85px solid #111; }
...
.tips-text-child2 { margin-left: 5px; }
.tips-text-child2-hidden { display: none; }
