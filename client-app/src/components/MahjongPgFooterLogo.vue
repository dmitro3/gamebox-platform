<template>
  <div id="svg-logo" ref="rootRef" class="svg-logo">
    <svg
      id="pg-footer-svg"
      class="pg-footer-svg"
      width="70"
    ...
    >
      <defs>
        <linearGradient
          ...
          y2="1"
        >
          <stop id="pg-grad-stop-0" offset="0" stop-color="#d888f3" />
          <stop id="pg-grad-stop-1" offset="0.5" stop-color="#8aadff" />
          <stop id="pg-grad-stop-2" offset="1" stop-color="#30f4e1" />
        </linearGradient>
      </defs>

      <g id="PG-Logo" transform="translate(4, 0)">
          <g id="PG-Color-Top">
            <path id="G-Yelow" fill-rule="evenodd" clip-rule="evenodd" d="M41.75 0H39.25V2.49997H41.75V0Z" fill="#FFB919">
              <animateTransform attributeName="transform" type="translate" dur="1.6s" values="0 0; 0 0; 0 -5; 0 0" keyTimes="0; 0.83; 0.88; 1" repeatCount="indefinite" />
            </path>
            <path id="G-Green" fill-rule="evenodd" clip-rule="evenodd" d="M61.5 11.2499H59V13.7498H61.5V11.2499Z" fill="#14E691">
              <animateTransform attributeName="transform" type="translate" dur="1.6s" values="0 0; 0 0; 0 -10; 0 0" keyTimes="0; 0.83; 0.88; 1" repeatCount="indefinite" />
            </path>
            ...
            <animate attributeName="opacity" dur="0.5s" values="0; 0; 1" keyTimes="0; 0; 1" repeatCount="1" fill="freeze" />
          </g>
          ...
          <g id="PG5">
            ...
            <animate attributeName="opacity" dur="0.5s" values="0; 0; 1" keyTimes="0; 0.8; 1" repeatCount="1" fill="freeze" />
          </g>
          <g id="PG4">
            ...
            <animate attributeName="opacity" dur="0.5s" values="0; 0; 1" keyTimes="0; 0.7; 1" repeatCount="1" fill="freeze" />
          </g>
          <g id="PG3">
            ...
            <animate attributeName="opacity" dur="0.5s" values="0; 0; 1" keyTimes="0; 0.6; 1" repeatCount="1" fill="freeze" />
          </g>
          <g id="PG2">
            ...
            <animate attributeName="opacity" dur="0.5s" values="0; 0; 1" keyTimes="0; 0.5; 1" repeatCount="1" fill="freeze" />
          </g>
          <g id="PG1">
            ...
            <animate attributeName="opacity" dur="0.5s" values="0; 0; 1" keyTimes="0; 0.3; 1" repeatCount="1" fill="freeze" />
          </g>
          <animateTransform attributeName="transform" type="translate" dur="1.5s" values="0 0; 0 0; 0 -5; 0 0" keyTimes="0; 0.88; 0.91; 1" repeatCount="indefinite" />
        </g>

      <g id="PG-Title" transform="translate(4, 31)" fill="#FFF">
...
onMounted(async () => {
  ...
  cleanup = mountPgLogoColorCycle(rootRef.value)
})
